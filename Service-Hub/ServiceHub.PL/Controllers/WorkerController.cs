...
//        public WorkerController(UnitWork unitWork,UserManager<ApplicationUser> userManager, UserStore userStore)
//        {
...
//            try
//            {
//                var data = await userStore.Users.Where(u=>u.role = "worker");
//                if (data != null)
//                {
...
//                        Email = data.Email,
//                        JobId = data.JobId,
//                        DistrictId = (int)data.DistrictId,
//                        Rating = data.Rating
